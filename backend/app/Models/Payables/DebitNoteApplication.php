 ...
 */
final class DebitNoteApplication extends Model
{
    use HasUuids;

    protected $table = 'payables_debit_note_applications';

    protected $fillable = [
        'debit_note_id', 'disposition_id', 'entity_id', 'target_document_id', 'amount', 'functional_amount',
