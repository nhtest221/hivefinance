 ...
 * @property string $source_bill_id
 ...
 * @property Collection<int,DebitNoteLine> $lines
 * @property Collection<int,DebitNoteDisposition> $dispositions
 * @property DebitNoteReversal|null $reversal
 */
final class DebitNote extends Model
{
    use HasUuids;

    protected $table = 'payables_debit_notes';

    protected $fillable = [
        'entity_id', 'document_number', 'provisional_token', 'vendor_id', 'source_bill_id',
    ...
    /** @return HasMany<DebitNoteLine, $this> */
    public function lines(): HasMany
    {
        return $this->hasMany(DebitNoteLine::class, 'debit_note_id')->orderBy('line_no');
    }

    /** @return HasMany<DebitNoteDisposition, $this> */
    public function dispositions(): HasMany
    {
        return $this->hasMany(DebitNoteDisposition::class, 'debit_note_id')->orderBy('created_at');
    }

    /** @return HasOne<DebitNoteReversal, $this> */
    public function reversal(): HasOne
    {
        return $this->hasOne(DebitNoteReversal::class, 'debit_note_id');
    }
}
