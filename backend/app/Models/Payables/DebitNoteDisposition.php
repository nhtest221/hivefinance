 ...
 * @property Collection<int,DebitNoteApplication> $applications
 */
final class DebitNoteDisposition extends Model
{
    use HasUuids;

    public $timestamps = false;

    protected $table = 'payables_debit_note_dispositions';

    protected $fillable = [
        'debit_note_id', 'entity_id', 'operation', 'amount', 'functional_amount', 'occurred_on',
    ...
    /** @return HasMany<DebitNoteApplication, $this> */
    public function applications(): HasMany
    {
        return $this->hasMany(DebitNoteApplication::class, 'disposition_id');
    }
}
