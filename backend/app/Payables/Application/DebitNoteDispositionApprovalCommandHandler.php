...
final readonly class DebitNoteDispositionApprovalCommandHandler implements ApprovalCommandHandler
{
    public function __construct(private DebitNoteDispositionService $disposition, private string $type) {}
