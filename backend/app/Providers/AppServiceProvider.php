...
use App\CurrencyFx\Infrastructure\EloquentRevaluationRunQuery;
...
use App\Payables\Infrastructure\EloquentPayablesReportQuery;
...
use App\Receivables\Infrastructure\EloquentReceivablesReportQuery;
...
final class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(RevaluationRunQuery::class, EloquentRevaluationRunQuery::class);
        ...
        $this->app->bind(ReceivablesReportQuery::class, EloquentReceivablesReportQuery::class);
        $this->app->bind(PayablesReportQuery::class, EloquentPayablesReportQuery::class);
