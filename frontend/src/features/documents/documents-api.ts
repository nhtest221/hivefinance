...
export type Invoice = { id: string; document_number: string | null; customer_id: string; invoice_date: string; due_date: string; currency: string; total: Money; open_balance: Money; status: 'draft' | 'sent'; version: number }
export type Bill = { id: string; document_number: string | null; vendor_id: string; bill_date: string; due_date: string; currency: string; total: Money; open_balance: Money; status: 'draft' | 'awaiting_payment'; version: number }
